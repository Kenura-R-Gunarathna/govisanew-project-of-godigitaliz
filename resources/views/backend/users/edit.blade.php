                ...
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a href="{{ route('admin.users') }}" class="btn btn-sm btn-primary"><span
                                    ...
                                    <div class="col-sm-8">
                                        <select name="category" id="category" class="form-control">
                                            <option value="consultant"
                                                {{ $profile->category == 'pending' ? 'selected' : '' }}>Consultants
                                            </option>
                                            <option value="lawyer" {{ $profile->category == 'lawyer' ? 'selected' : '' }}>
                                                Lawyers</option>
                                            <option value="private"
                                                {{ $profile->category == 'private' ? 'selected' : '' }}>Private Colleges
                                            </option>
                                        </select>
                                        @error('category')
                                            <div class="alert alert-info alert-dismissable alert-style-1">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="status" id="status" class="form-control">
                                            <option value="active" {{ $profile->status == 'active' ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="suspend"
                                                {{ $profile->status == 'suspend' ? 'selected' : '' }}>Suspend</option>
                                            <option value="pending"
                                                {{ $profile->status == 'pending' ? 'selected' : '' }}>Pending</option>
                                        </select>
                                        @error('status')
                                            <div class="alert alert-info alert-dismissable alert-style-1">
                                                <button type="button" class="close" data-dismiss="alert"
                                    ...
                                    <div class="col-sm-8">
                                        <select name="role" id="role" class="form-control">
                                            ...
                                            <option value="provider"
                                                {{ $profile->role == 'provider' ? 'selected' : '' }}>Provider</option>
                                    ...
                                    <div class="col-sm-8">
                                        <div class="checkbox checkbox-primary">
                                            <input id="checkbox2" type="checkbox"
                                                {{ $profile->is_featured == 1 ? 'checked' : '' }} name="is_featured">
