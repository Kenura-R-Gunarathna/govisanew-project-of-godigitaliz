        ...
        <div class="row heading-bg">
            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <ol class="breadcrumb">
                    ...
                    <li><a href="{{ route('admin.testimonials') }}"><span>Testimonials</span></a></li>
                </ol>
            </div>
        </div>
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">update testimonial</h6>
                        </div>
                        <div class="pull-right">
                            <a href="{{ route('admin.testimonials') }}" class="btn btn-sm btn-primary"><span class="btn-text">Back</span></a>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                    <div class="panel-wrapper">
                        <div class="panel-body">
                          <form method="post" action="{{ route('admin.testimonials.update', $testimonial->id) }}" class="form-horizontal">
                                @csrf
                                <div class="form-group">
                                    <label class="control-label mb-10 col-sm-4" for="link">Link  :</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="link" name="link" value="{{  $testimonial->link }}">
                                        @error('link')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="checkbox" name="is_featured" value="1" {{ ($testimonial->is_featured == 1) ? "checked" : "" }} class="js-switch js-switch-1"  data-color="#03233B" data-size="large"/>
                                        @error('is_featured')
                                        <div class="alert alert-info alert-dismissable alert-style-1">
                                            <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                                            <i class="zmdi zmdi-info-outline"></i>{{ $message }}
