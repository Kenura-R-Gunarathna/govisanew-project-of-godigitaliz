                                    ...
                                    <tbody>
                                        @if($testimonials)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                  <a href="{{ route('admin.testimonials.edit',   $testimonial->id) }}" class="btn btn-xs btn-primary">Edit</a>  
                                                  <button type="button" id="delete" data-id="{{ $testimonial->id }}" class="btn btn-xs btn-default">Delete</button>  
                                                </td>
                                            </tr>
                                            @endforeach
                                        @endif 
