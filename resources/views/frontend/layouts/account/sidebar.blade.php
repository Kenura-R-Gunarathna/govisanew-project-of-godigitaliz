<ul class="nav navbar-nav side-nav nicescroll-bar">
    ...
    @if(auth()->user()->role == 'provider')
        ...
        <li>
            <a href="{{ route('account.billing') }}" class="{{ request()->routeIs('account.billing') ? 'active' : '' }}"><div class="pull-left"><i class="ti-layout-media-overlay-alt-2 mr-20"></i><span class="right-nav-text">Billing</span></div><div class="clearfix"></div></a>
        </li>
        <li>
