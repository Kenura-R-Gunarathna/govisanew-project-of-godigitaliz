                    ...
                    <div class="panel-body pa-0">
                        <div class="sm-data-box">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-xs-6 text-center pl-0 pr-0 data-wrap-left">
                                        <span class="txt-dark block counter"><span class="counter-anim">{{ $booking_count }}</span></span>
                                        <span class="capitalize-font block">Booking</span>
                                    </div>
                                    <div class="col-xs-6 text-center  pl-0 pr-0 data-wrap-right">
                                        <i class="ti-calendar data-right-rep-icon"></i>
                                    </div>
                                </div>
                                <div class="progress-anim">
                                    <div class="progress">
