                ...
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            ...
                            <a href="{{ route('google.connect') }}" class="btn btn-sm btn-default">Google Calendar</a>
                        </div>
			...
			$('#dataTableElement').DataTable({
				...
				columnDefs: [
                    ...
                    },
                    {
                        ...
                        orderable: false,
                        render : function ( data, type, row, meta ) {
							var template  = '<select name="status" id="statusChange" data-id="'+data+'" class="form-control">';
