                    ...
                    <div class="row m-0">
                        <div class="col-md-6 mb-3">
                            <h2 class="fw-bold">
                                ...
                                <span class="h6 fw-semibold" style="color: #B1B1B1;">
                                @if(isset($account->document)) 
                                    @if($account->document->trust_score)
                                        {{ $account->document->trust_score }}
                                    @else
                                        0
                                    @endif
                                 @endif
                    ...
                    <div id="descriptionList" class="row m-0">
                        <div class="col-md-6 mb-3">
                            <ul class="list-group rounded-0">
                                ...
                                <li class="list-group-item">Business License: 
                                    @if(isset($account->document)) 
                                       @if($account->document->business_license_status == "approved")
                                ...
                                <li class="list-group-item">RCIC License:
                                    @if(isset($account->document)) 
                                       @if($account->document->rcic_license_status == "approved")
                                       <i class="bi bi-check-circle-fill text-success"></i>
                                       @else
                                         N/A
                                       @endif
                                ...
                                <li class="list-group-item">Social Score: 
                                    @if(isset($account->document)) 
                                       @if($account->document->social_score_value)
                                          {{ $account->document->social_score_value }}
                                        @else
                                         N/A
                                       @endif
                                    @endif
                        ...
                        <div class="col-md-6 mb-3">
                            <ul class="list-group rounded-0">
                                <li class="list-group-item">PMR course taken: 
                                    @if(isset($account->document)) 
                                       @if($account->document->pmr_course_certificate_status == "approved")
                                       <i class="bi bi-check-circle-fill text-success"></i>
                                        @else
                                         N/A
                                       @endif
                                ...
                                <li class="list-group-item">Case Approval Rate: 
                                    @if(isset($account->document)) 
                                       @if($account->document->case_approval_rate)
                                          {{ $account->document->case_approval_rate }}
                                        @else
                                         N/A
                                       @endif
                                    @endif
                                </li>
                                <li class="list-group-item">Client Reviews: <i class="bi bi-check-circle-fill text-success"></i></li>
                                <li class="list-group-item">References: <i class="bi bi-check-circle-fill text-success"></i></li>
                                <li class="list-group-item">Minimum 10 Approved Cases: 
                                    @if(isset($account->document)) 
                                       @if($account->document->case_approval_status == "approved")
                                       <i class="bi bi-check-circle-fill text-success"></i>
                                       @else
                                         N/A
                                       @endif
    ...
    <script type="text/javascript">
        ...
        function onClickedConfirmBooking(){
         ...
         $("#onClickSave").click(function(){
            ...
            var url = '{{ route('profile.create.review', ':slug') }}';
            if(star){
                $.ajax({
